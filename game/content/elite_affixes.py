...
ELITE_AFFIX_DEFS: dict[str, EliteAffixDef] = {
    ...
    "skirmisher": _elite(
        "skirmisher",
        "Skirmisher",
        "A darting raider that slips in and out before the line can settle.",
        "It keeps darting in and out of reach.",
        "Pin it in a corner or slow it before it slips away.",
        attack_bonus=1,
    ...
    "gravebound": _elite(
        "gravebound",
        "Gravebound",
        "Grave-chill clings to its bones and makes it stubborn under pressure.",
        "A grave-cold haze hangs around its frame.",
        "Burst it down before the grave-chill can harden its guard.",
        attack_bonus=1,
        defense_bonus=2,
    ...
    "venomous": _elite(
        "venomous",
        "Venomous",
        "Its claws and fangs drip with a lingering toxin.",
        "Sickly green venom glistens along its weapons.",
        "Keep the party spread and strike it from outside its reach.",
        attack_bonus=2,
    ...
    "gold_taker": _elite(
        "gold_taker",
        "Gold-Taker",
        "A greedy raider that fights harder when it thinks loot is near.",
        "Coins clatter as it lunges for the spoils.",
        "Focus it early so it never gets paid in blood.",
        attack_bonus=1,
        defense_bonus=1,
    ...
    "oathbound": _elite(
        "oathbound",
        "Oathbound",
        "An oath-sworn elite stiffens nearby allies with its resolve.",
        "A pale oath-sigil pulses at its shoulder.",
        "Break the oathkeeper first or scatter its allies.",
        attack_bonus=1,
        defense_bonus=1,
        aura_attack_bonus=1,
        aura_radius_tiles=3.5,
        courage_bonus=2,
        spawn_marker="oath",
    ),
}
