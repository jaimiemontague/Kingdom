"""WK61 R10 — apply UrsinaApp patch for hold-G tax overlay capture (import before main)."""
...
def apply_patch() -> None:
    ...
    def patched_init(self, ai_controller_factory):
        ...
        print(f"[wk61-r10-capture] Seeded tax gold on: {sorted(set(seeded))}", flush=True)
