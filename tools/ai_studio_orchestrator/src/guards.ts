...
const OWNERSHIP: Record<string, RegExp[]> = {
  ...
  "06": [/^ai\//, /^tests\//],
  "08": [/^game\/ui\//, /^game\/engine_facades\/render_coordinator\.py$/, /^game\/engine\.py$/, /^game\/world\.py$/, /^tools\/screenshot_scenarios\.py$/, /^tools\/capture_screenshots\.py$/, /^assets\/ui\//, /^tests\//],
