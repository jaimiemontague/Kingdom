...
1. In `SimEngine.__init_`_, register an event listener for `poi_combat_triggered`
...
5. Add spawned en
6. mies to `self.enemies` list
7. Enemies appear at random positions within POI footprint
