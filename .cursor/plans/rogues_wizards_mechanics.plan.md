---
name: Rogues+Wizards (Majesty mechanics)
overview: Add Rogue and Wizard hero classes with their guild buildings, class-tuned stats, class-flavored AI (bounty preference + spacing/cowardice), marketplace item progression, and observer validation. Keep implementation simple and consistent with the existing Ranger approach (no palace levels, no spell research trees).
---
